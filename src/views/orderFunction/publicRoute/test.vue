<template>
  <div class="box">
    ...
    <!--  <el-radio-group v-model="sheetType" size="large" @change="changeSheetType">
      <el-radio-button label="1">装机单</el-radio-button>
      <el-radio-button label="5">修机单</el-radio-button>
      <el-radio-button label="3" disabled>意向单</el-radio-button>
    </el-radio-group> -->
  </div>
</template>

<script>
import { location } from "@/utils/public/positionLoaction";
export default {
  name: "Test",
  data() {
    return {
  ...
  methods: {
    /* changeSheetType(lab) {
      console.log("2222222222222选择", lab);
    }, */
