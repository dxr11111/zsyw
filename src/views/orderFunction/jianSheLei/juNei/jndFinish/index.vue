  ...
  methods: {
    submit() {
      ...
      if (this.checkisOverTime) {
        ...
        this.params = {
          ...this.params,
          overtimeReason: String(this.overtimeReason),
          overtimeItem: String(this.overtimeItem),
    ...
    async getBeforeList() {
      let data = await JndBeforeFinishApi(
      ...
      if (!data.operationSuccessFlag) return this.$toast(data.errorMessage);
    },
    chooseTime(value) {
