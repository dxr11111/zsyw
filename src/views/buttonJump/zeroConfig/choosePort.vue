...
export default {
  ...
  methods: {
    ...
    getVoiceData () {
      ...
      this.voiceList.slotPositionActions = [{ name: this.voiceList.slotPosition }]
      // 获取语音端口
      ...
      this.dataList.slotPositionActions = [{ name: this.dataList.slotPosition }]
      // 获取数据端口
