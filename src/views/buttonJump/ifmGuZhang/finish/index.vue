...
export default {
  ...
  methods: {
    ...
    async getFinishQuery() {
      let result = await reqFinishQuery(
    ...
    receiptCheck() {
      ...
      if (this.hasWorkType) {
        ...
        if (
          this.balkSubSortId20Show ||
          this.balkSubSortId21Show ||
          this.balkSubSortId22Show
        ) {
          if (this.dealDate == "") return this.$toast("请选择处理时间");
          if (this.faultFeedbackInfo == "")
            return this.$toast("请输入排障反馈详情");
        }
