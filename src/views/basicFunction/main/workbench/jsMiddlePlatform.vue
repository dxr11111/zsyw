    ...
    <div class="platformBg">
      ...
      <div class="board">
        ...
        <ul class="boardList">
          ...
          <li class="listItem yuJing" @click="clickOrder('xmyj')">
...
export default {
  ...
  methods: {
    ...
    clickOrder(order) {
      ...
      if (order == "xmyj") {
        // 项目预警
        url = prefix + this.xmyjUrl + loginNo;
      } else {
        // 其他
        url = prefix + order.skipUrl + loginNo;
      }
      console.log("跳转路径", url);
      setItem("jsMiddlePlatformFlag", {
        isLocation: true,
        isCreate: false,
        projectFlag: this.$store.state.projectFlag,
      });
